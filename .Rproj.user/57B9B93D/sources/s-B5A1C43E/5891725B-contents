...
#------------------------------------------------------------------------
ggsave("Mapa del Peru/Mapa del Peru.png",
           plot = P1, width =  7,height = 9, dpi=900)
ggsave("Mapa del Peru/Mapa del Peru1.png",
           plot = P2, width =  7,height = 9, dpi=900)
ggsave("Mapa del Peru/Mapa del Peru2.png",
           plot = P3, width =  7,height = 9, dpi=900)
ggsave("Mapa del Peru/Mapa del Peru3.png",
